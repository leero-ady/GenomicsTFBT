...
alphabetToIntegerTrain = alphabetToInteger[..., np.newaxis]
...
model.fit(alphabetToIntegerTrain, labelvector, batch_size=128, epochs=500, verbose=1, shuffle=True, validation_split=0.25, callbacks=[checkpoint])
